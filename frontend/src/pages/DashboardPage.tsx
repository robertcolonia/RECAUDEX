...
export function DashboardPage() {
  ...
  return <div className="dashboard-page" ref={pageRef}>
    <div className="page-heading heading-row" data-reveal><div><span className="overline dark">VISIÓN EJECUTIVA</span><h1>Torre de control</h1><p>Estado consolidado del ciclo de ingresos de {user?.organizationName || "la organización"}.</p></div><div className="heading-actions"><Link className="button primary" to="/demo"><PlayCircle size={16} /> Iniciar demo MVP</Link><button className="button secondary" onClick={() => query.refetch()}><RefreshCw size={16} /> Actualizar</button></div></div>
    ...
    <section className="dashboard-grid">
      <div className="panel agents-panel" data-reveal>
      ...
      <div className="panel activity-panel" data-reveal>
